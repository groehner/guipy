...
Const
  ...
  SErrorLoadLayout = 'Failed to load layout from "%s". Please close and restart GuiPy';
  ...
  SRpycNotAvailable = 'The ''rpyc'' package is not available.' + SLineBreak +
                      'Please restart GuiPy and try again.' + SLineBreak +
                      'If the error persists reinstall GuiPy.';
  ...
  SAccessAppDataDir = 'GuiPy needs access to the User Application Data directory: "%s". '+
  ...
  SUnknownPythonVersion = 'GuiPy can''t use command line parameter PYTHON%s because it doesn''t know this version of Python.';
  SUnsupportedPythonVersion = 'GuiPy can''t use command line parameter PYTHON%s because it was compiled for Python %s or later.';
  ...
  SSelectModifiedFiles = 'The following files have been modified.' + SLineBreak +
    ...
    'Press ''Cancel'' to return to GuiPy without saving files.';
...
{gnugettext: reset }
  ...
  STkinterFileTemplate =
    ...
    'import tkinter.ttk as ttk' + sLineBreak +
    '' + sLineBreak +
    'class app(tk.Frame):' + sLineBreak +
    '' + sLineBreak +
  ...
  SHTMLFileTemplate = // do not localize
    '<!-- Created: $[DateTime-''DD/MM/YYYY''-DateFormat] by $[Author] -->' + sLineBreak +
    ...
    '    <meta name="generator" content="GuiPy">' + sLineBreak +
    '  </head>' + sLineBreak +
    '  <body>' + sLineBreak +
    '' + sLineBreak +
    '  </body>' + sLineBreak +
